...
export default PaginationBar = function(props/*: any */)/*: HTMLElement */ {
  ...
  filterClickHandler = function() {
    ...
    state = (ref = state === 'folded') != null ? ref : {
      'unfolded': 'folded'
    };
  ...
  return <nav className={'pagination-bar pagination-bar_theme_1'}>
		<div className='pagination-bar__filter_theme_1' onClick={filterClickHandler}>
		...
		<div className='pagination-bar__add-article_theme_1' onClick={addClickHandler}>
